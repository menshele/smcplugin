...
public class SmcParser implements PsiParser, LightPsiParser {
  ...
  private static boolean next_state_0(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = next_state_0_0(b, l + 1);
    r = r && next_state_0_1(b, l + 1);
    r = r && next_state_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // comment*
  private static boolean next_state_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "next_state_0_0")) return false;
    int c = current_position_(b);
    while (true) {
      if (!comment(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "next_state_0_0", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  private static boolean next_state_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "next_state_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // comment*
  private static boolean next_state_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "next_state_0_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!comment(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "next_state_0_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // START_KEYWORD comment* START_MAP_NAME comment* START_MAP_NAME_STATE_NAME_SEPARATOR comment* START_STATE_NAME
  public static boolean start_state(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, START_MAP_NAME_STATE_NAME_SEPARATOR);
  ...
  /* ********************************************************** */
  // STATE_NAME comment* ((entry exit)|(exit entry)|((entry|exit)?))? comment* BRACE_OPEN comment* transitions comment* BRACE_CLOSE
  public static boolean state(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, state_2(b, l + 1)) && r;
    r = p && report_error_(b, state_3(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, BRACE_OPEN)) && r;
    r = p && report_error_(b, state_5(b, l + 1)) && r;
    r = p && report_error_(b, transitions(b, l + 1)) && r;
    r = p && report_error_(b, state_7(b, l + 1)) && r;
    r = p && consumeToken(b, BRACE_CLOSE) && r;
  ...
  private static boolean state_2_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = state_2_0_0(b, l + 1);
    if (!r) r = state_2_0_1(b, l + 1);
    if (!r) r = state_2_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // entry exit
  private static boolean state_2_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "state_2_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = entry(b, l + 1);
    r = r && exit(b, l + 1);
  ...
  // exit entry
  private static boolean state_2_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "state_2_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = exit(b, l + 1);
    r = r && entry(b, l + 1);
  ...
  // (entry|exit)?
  private static boolean state_2_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "state_2_0_2")) return false;
    state_2_0_2_0(b, l + 1);
    return true;
  }

  // entry|exit
  private static boolean state_2_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "state_2_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = entry(b, l + 1);
    if (!r) r = exit(b, l + 1);
  ...
  private static boolean state_3(PsiBuilder b, int l) {
    ...
    while (true) {
      if (!comment(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "state_3", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // comment*
  private static boolean state_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "state_5")) return false;
    int c = current_position_(b);
    while (true) {
      if (!comment(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "state_5", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // comment*
  private static boolean state_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "state_7")) return false;
    int c = current_position_(b);
    while (true) {
      if (!comment(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "state_7", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // comment* TRANSITION_NAME comment* transition_args? comment* guard? comment* next_state comment* BRACE_OPEN comment* actions comment* BRACE_CLOSE
