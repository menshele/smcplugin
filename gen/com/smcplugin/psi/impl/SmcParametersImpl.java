...
public class SmcParametersImpl extends ASTWrapperPsiElement implements SmcParameters {

  public SmcParametersImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SmcVisitor) ((SmcVisitor)visitor).visitParameters(this);
